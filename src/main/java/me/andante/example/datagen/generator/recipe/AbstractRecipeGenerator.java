package me.andante.example.datagen.generator.recipe;
...
public abstract class AbstractRecipeGenerator implements Consumer<BiConsumer<Identifier, CraftingRecipeJsonFactory>> {
    protected final String modId;
    private final Map<Identifier, CraftingRecipeJsonFactory> factoryMap;
    ...
    @Override
    public void accept(BiConsumer<Identifier, CraftingRecipeJsonFactory> biConsumer) {
        this.generate();
    ...
    public AbstractRecipeGenerator add(Identifier id, CraftingRecipeJsonFactory factory) {
